...
# Constants for difficulty level (currently set to 'medium')
ABILITY_P = 0.5  # Probability for abilities (medium difficulty)
TASK_P = 0.5     # Probability for task difficulties (medium difficulty)
