...
# Constants for difficulty level (currently set to 'easy')
ABILITY_P = 0.7  # Probability for abilities (easy difficulty)
TASK_P = 0.3     # Probability for task difficulties (easy difficulty)
